...
void setup() {
  ...
  myNex.begin(NEXTION_BAUD); //setup serial connection to Nextion Display. todo: can this be 115200?
  ...
  initialize_pid(0); //initialize pid with a default setpoint of 0c. Leave in manual mode by default
